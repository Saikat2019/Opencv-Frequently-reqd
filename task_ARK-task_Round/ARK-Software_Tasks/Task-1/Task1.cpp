...
//run the programme and see the terminal for out put and furthur instruction
//press any key to stop at any moment and to exit also
         ...
         for(i=0;i<frame.rows;i++)
            {
              for(j=0;j<frame.cols;j++)
                 {
                    if(frame.at<Vec3b>(i,j)[0]>220 && frame.at<Vec3b>(i,j)[1]>220 && frame.at<Vec3b>(i,j)[2]>220)
                        {
