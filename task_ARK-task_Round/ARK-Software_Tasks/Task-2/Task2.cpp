...
// run it and see the treminal for furthur instruction
...
int main()
   {
      ...
      cout<<">>>>>>> Choose the start point and the end point in the graph by left click ---"<<endl;
      while(1)
      {
         imshow("Graph",graph);
         waitKey(10);
    ...
    for(a=0;a<50000;a++)
     ...
     path.push(end.p);
      ...
      do 
       ...
       path.push(start.p);  
       cout<<"\n\n\n\n>>>>>>> and the consisting points of the path are stored in the stack 'path'\n\n"<<endl;       
