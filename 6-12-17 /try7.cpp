...
void updateBmax(int ,void * saikat1)
    {
    }
    
void updateBmin(int ,void * saikat2)
    {
    }    

void updateGmax(int ,void * saikat3)
    {
    }
    
void updateGmin(int ,void * saikat4)
    {
    }    
    
void updateRmax(int ,void * saikat5)
    {
    }    

void updateRmin(int ,void * saikat6)
    {
    }
...
int main()
   {
      ...
      createTrackbar("trackBmax","video",&Bmax,255,updateBmax);
      createTrackbar("trackBmin","video",&Bmin,255,updateBmin);
      createTrackbar("trackGmax","video",&Gmax,255,updateGmax);
      createTrackbar("trackGmin","video",&Gmin,255,updateGmin);
      createTrackbar("trackRmax","video",&Rmax,255,updateRmax);
      createTrackbar("trackRmin","video",&Rmin,255,updateRmin); 
      createTrackbar("no of erosion","video",&me,5,updatemorph); 
      createTrackbar("no of dilationion","video",&md,5,updatemorph); 
      int i,j;
